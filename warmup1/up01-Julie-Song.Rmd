...
#### Definition: 
  + **Quadratic equation** is any equation having the form \[ax^2   + bx + c = 0\] where x represents an unknown, and *a, b* and *c* represnt known numbers such that *a* is not equal to 0. To find the solution for quadratic equation, use the following formula: \[x = \frac{-b \pm\sqrt{b^2 - 4ac}}{2a}\] (source: [Wikipedia](https://en.wikipedia.org/wiki/Quadratic_equation))
